    ...
    $data = $colaboradores->listarColaboradores();
      if ($data){
        ...
        foreach($data as $registro){
          $datosEstudiante = $registro['personas'];
          echo "
            <tr>
              <td>{$numeroFila}</td>,
          ...
          if ($registro['cv']== ''){
            ...
            echo "<a href='../views/img/cv/{$registro['cv']}' class='btn btn-sm btn-outline-primary'title='ver'><i class='bi bi-file-earmark-pdf'></i></a>";
          }
