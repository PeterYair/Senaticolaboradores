...
BEGIN
	...
	IF _cv 	= '' THEN -- (THEN)Es cuando la condicion y la expresion coinciden --
	SET _cv = NULL; -- (SET)Asigna el valor a una variable -- 
	END IF; -- Permite a su metodo elegir entre dos acciones dependiendo de si una prueba (Una expression Booleana) es verdadera--
